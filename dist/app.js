...
app.post('/api/seller', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name } = req.body;
        // Generate a unique QR code for the seller
        const sellerId = `seller-${new Date().getTime()}`;
        const qrCode = yield QRCode.toDataURL(sellerId);
...
//   }
// });
app.get('/api/retailer/profile', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
//   }
// });
app.post('/api/retailer/onboard', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { retailerName, sellerQrCode } = req.body;
        ...
        // Generate a unique QR code for the retailer
        const retailerQrCode = `retailer-${new Date().getTime()}`;
        const qrCode = yield QRCode.toDataURL(retailerQrCode);
        // Save retailer in the database
        const retailer = yield prisma.retailer.create({
            data: {
                name: retailerName,
                qrCode: retailerQrCode,
                sellerId: seller.id,
...
app.post('/api/retailer/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
